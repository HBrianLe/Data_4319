...
# ╔═╡ 59dfe8f0-3052-11eb-20c6-c7c8126c1ded
md"""

`CKD Color = ` $(@bind t html"<input type=color >")

`No CKD  Color = ` $(@bind y html"<input type=color >")
...
md"""
`Point = ` $(@bind a html"<input type=range >")

`K-Neigbors = ` $(@bind k html"<input type=range >")

`Line Color = ` $(@bind f html"<input type=color >")
...
# ╔═╡ a1559a20-3054-11eb-2eb7-e57ebb5e186c
a

# ╔═╡ 6e85a3c0-1bb3-11eb-38aa-c546c66bb8cb
...
# ╔═╡ 75766630-3051-11eb-2353-65c321263b5a
predict(a, x_data, y_data, k)
